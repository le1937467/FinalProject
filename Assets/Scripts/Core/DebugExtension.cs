...
public static class DebugExtension
{
    ...
    public static void DebugRectangle(Vector2 center, Vector2 size, Color color, float duration = 0f, bool depthTest = true)
    {
        var halfSize = size * 0.5f;
        var topLeft = center; topLeft.x -= halfSize.x; topLeft.y += halfSize.y;
        var topRight = center; topRight.x += halfSize.x; topRight.y += halfSize.y;
        var bottomLeft = center; bottomLeft.x -= halfSize.x; bottomLeft.y -= halfSize.y;
        var bottomRight = center; bottomRight.x += halfSize.x; bottomRight.y -= halfSize.y;
    ...
    public static void DebugCircle2D(Vector2 position, Color color, float duration = 0, float radius = 0.5f, bool depthTest = true)
    {
